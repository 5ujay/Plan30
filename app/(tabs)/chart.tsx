    ...
    <View className="flex-1">
      ...
      <View className="flex-1 justify-between px-4 py-6">
        ...
        <View className="mt-4">
          ...
          <Text className="text-[#000] text-lg font-medium text-center mt-2">
        ...
        <View className="mt-10 items-center">
          <Text className="text-[#000] text-xl font-semibold mb-6">
        ...
        <View className="flex flex-row justify-between items-center mt-6 space-y-4">
          ...
          <TouchableOpacity
            onPress={handleReset}
            className="bg-black py-3 px-6 rounded-lg shadow-md"
          >
